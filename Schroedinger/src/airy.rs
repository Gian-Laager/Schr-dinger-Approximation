...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct airy_ai_return {
    pub r0: GoFloat64,
    pub r1: GoFloat64,
}
#[test]
fn bindgen_test_layout_airy_ai_return() {
    assert_eq!(
        ::std::mem::size_of::<airy_ai_return>(),
        16usize,
        concat!("Size of: ", stringify!(airy_ai_return))
    );
    assert_eq!(
        ::std::mem::align_of::<airy_ai_return>(),
        8usize,
        concat!("Alignment of ", stringify!(airy_ai_return))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<airy_ai_return>())).r0 as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(airy_ai_return),
            "::",
            stringify!(r0)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<airy_ai_return>())).r1 as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(airy_ai_return),
...
extern "C" {
    pub fn airy_ai(zr: GoFloat64, zi: GoFloat64) -> airy_ai_return;
}
